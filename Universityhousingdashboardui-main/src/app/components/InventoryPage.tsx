                ...
                {mockRoomCustody[roomSearch] ? (
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-xl font-bold text-[#002147]">
                        قائمة عهدة الغرفة رقم {roomSearch}
                      </h3>
                      <span className="bg-[#002147] text-white px-3 py-1 rounded-lg text-xs font-bold">
                        4 طالب مسجل
                      </span>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200 flex justify-end gap-3">
                      <button className="px-6 py-2.5 rounded-xl font-bold text-gray-500 hover:bg-gray-100 transition-all">
                        تحميل كتقرير
                      </button>
                      <button className="bg-[#002147] text-white px-6 py-2.5 rounded-xl font-bold hover:bg-[#003366] transition-all shadow-md">
                        اعتماد الجرد الدوري
                      </button>
                    </div>
                  </motion.div>
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center text-gray-400 py-12">
                    ...
                    <p className="font-bold text-center">
                      قم بالبحث برقم الغرفة لاستعراض قائمة العهدة الخاصة بها
                      <br />
                      والتأكد من سلامة المرفقات
                    </p>
                  </div>
                )}
              </div>
