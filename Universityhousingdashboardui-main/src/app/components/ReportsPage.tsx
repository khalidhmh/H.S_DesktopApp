            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <ResponsiveContainer width="100%" height={250}>
                  {selectedTopic === 'attendance' ||
                  selectedTopic === 'absence' ||
                  selectedTopic === 'penalties' ? (
                    <BarChart data={reportData.summary}>
                      ...
                      <Tooltip />
                      <Legend />
                      {Object.keys(reportData.summary[0])
                        .filter((key) => key !== 'name')
                        .map((key, index) => (
                          <Bar
                            key={key}
                            dataKey={key}
                            fill={['#10B981', '#F59E0B', '#EF4444', '#8B5CF6'][index]}
                          />
                        ))}
                    </BarChart>
                  ) : (
                      ...
                      {Object.keys(reportData.summary[0])
                        ...
                        .map((key, index) => (
                          <Line
                            ...
                            type="monotone"
                            dataKey={key}
                            stroke={['#8B5CF6', '#10B981', '#F59E0B'][index]}
                            strokeWidth={2}
                          />
                        ))}
                    </LineChart>
                ...
                <thead>
                  <tr className="bg-[#002147] text-white">
                    {Object.keys(reportData.tableData[0]).map((header) => (
                      <th
                        key={header}
                        className="px-4 py-3 text-right font-bold border border-gray-300"
                      >
                        {header}
                      </th>
                    ))}
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              اختر نوع التقرير وقم بإنشاء تقارير شاملة عن نشاطات السكن
            </p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 text-right">
                  <h3 className="text-lg font-bold text-[#002147] mb-1">{type.label}</h3>
              ...
              <div>
                {filterType === 'floor' ? (
                  ...
                  >
                    ...
                    <option value="الطابق الأول" className="text-gray-900">
                      الطابق الأول
                    </option>
                    <option value="الطابق الثاني" className="text-gray-900">
                      الطابق الثاني
                    </option>
                    <option value="الطابق الثالث" className="text-gray-900">
                      الطابق الثالث
                    </option>
                    <option value="الطابق الرابع" className="text-gray-900">
                      الطابق الرابع
                    </option>
                    <option value="الطابق الخامس" className="text-gray-900">
                      الطابق الخامس
                    </option>
                    <option value="الطابق السادس" className="text-gray-900">
                      الطابق السادس
                    </option>
                  </select>
                ) : filterType === 'college' ? (
                  ...
                  >
                    ...
                    <option value="كلية الهندسة" className="text-gray-900">
                      كلية الهندسة
                    </option>
                    <option value="كلية الطب" className="text-gray-900">
                      كلية الطب
                    </option>
                    <option value="كلية العلوم" className="text-gray-900">
                      كلية العلوم
                    </option>
                    <option value="كلية الآداب" className="text-gray-900">
                      كلية الآداب
                    </option>
                    <option value="كلية إدارة الأعمال" className="text-gray-900">
                      كلية إدارة الأعمال
                    </option>
                    <option value="كلية الحاسبات" className="text-gray-900">
                      كلية الحاسبات
                    </option>
                  </select>
                ) : (
