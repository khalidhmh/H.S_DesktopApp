        ...
        >
            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-start mb-3">
                    <span className={cn("text-xs font-bold px-2.5 py-1 rounded-full", statusColors[student.status])}>
                        {statusLabels[student.status] || student.status}
                    </span>

                    <div className="flex space-x-1 space-x-reverse">
                        {student.hasPenalties && (
                            <div className="text-red-500 animate-pulse bg-red-50 p-1 rounded-full" title="عليه جزاءات">
                                <AlertCircle size={18} />
                            </div>
                        )}
                ...
                <div className="flex flex-col items-center mb-4">
                    ...
                    <h3 className="mt-3 text-lg font-bold text-[#002147] text-center line-clamp-1">{student.name}</h3>
                    <p className="text-sm text-gray-500 text-center">{student.college} • السنة {student.year}</p>
                </div>
                ...
                <div className="space-y-2 border-t border-gray-100 pt-3 text-sm text-gray-600">
                    <div className="flex items-center justify-end group-hover:text-[#002147] transition-colors">
                        <span dir="rtl">غرفة {student.roomNumber} - طابق {student.floor}</span>
