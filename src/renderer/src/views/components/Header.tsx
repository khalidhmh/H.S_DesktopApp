...
export const Header = () => {
    ...
    const getPageTitle = (pathname: string) => {
        switch (pathname) {
            ...
            case '/attendance': return 'التمام اليومي';
            case '/complaints': return 'الشكاوى';
            case '/maintenance': return 'طلبات الصيانة';
            case '/penalties': return 'المخالفات';
            default: return 'نظام المدن الجامعية';
        }
    };
                            ...
                            <div className="absolute top-full mt-2 right-0 w-96 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden z-50">
                                {loading ? (
                                    ...
                                    <div className="max-h-[400px] overflow-y-auto">
                                                ...
                                                {results.students.map(student => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="overflow-hidden">
                                                            <p className="text-sm font-medium text-gray-700 group-hover:text-primary truncate">{student.name}</p>
                                                            <p className="text-xs text-gray-400 truncate">{student.universityId} • {student.room ? `غرفة ${student.room.roomNumber}` : 'غير مسكن'}</p>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                        ...
                                        {results.students.length > 0 && results.rooms.length > 0 && <div className="border-t border-gray-100 mx-2" />}
                                            ...
                                            <div className="p-2">
                                                ...
                                                {results.rooms.map(room => (
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <p className="text-sm font-medium text-gray-700 group-hover:text-primary">غرفة {room.roomNumber}</p>
