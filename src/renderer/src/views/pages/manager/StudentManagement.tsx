...
export default function StudentManagement() {
    ...
    const filteredStudents = students.filter(student => {
        const matchesSearch =
            student.nameArabic.includes(searchQuery) ||
        ...
        <div className="p-8 space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 mt-2">إدارة بيانات الطلاب والمتابعة السكنية</p>
                </div>
                <Button
            ...
            <div className="flex gap-4 items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="relative flex-1">
                    ...
                    <Input
                        placeholder="بحث بالاسم، الرقم الجامعي..."
                        className="pr-10"
                        value={searchQuery}
                        ...
                        {isLoading ? (
                            ...
                            Array.from({ length: 5 }).map((_, i) => (
                                <TableRow key={i}>
                                    ...
                                    <TableCell><div className="h-6 w-16 mx-auto bg-gray-100 rounded-full animate-pulse" /></TableCell>
                                    <TableCell><div className="h-8 w-20 mx-auto bg-gray-100 rounded animate-pulse" /></TableCell>
                                </TableRow>
                            ))
                                ...
                                <TableRow key={student.id} className="group">
                                    <TableCell className="font-medium">
                                        <div className="flex items-center gap-3">
                                            <Avatar>
                                                ...
                                                <AvatarFallback>{student.nameArabic.slice(0, 2)}</AvatarFallback>
                                            </Avatar>
                                            <div>
                                                <p className="text-primary font-bold">{student.nameArabic}</p>
                                    ...
                                    <TableCell>
                                        <div className="space-y-1">
                                            <p className="text-sm font-medium">{student.building}</p>
                                            <p className="text-xs text-gray-500">غرفة {student.room}</p>
                                        </div>
                                    </TableCell>
