...
async function main() {
    ...
    const studentsData = [
        { name: 'Ahmed Ali', universityId: '2024001', college: 'Engineering', year: '1', nationalId: '10000000000001', status: 'ACTIVE', roomId: createdRooms[0].id },
        { name: 'Mohamed Samy', universityId: '2024002', college: 'Medicine', year: '2', nationalId: '10000000000002', status: 'ACTIVE', roomId: createdRooms[0].id },
        { name: 'Sara Hassan', universityId: '2024003', college: 'Science', year: '1', nationalId: '10000000000003', status: 'EVACUATED' },
        { name: 'Khaled Hussein', universityId: '20240325', college: 'Arts', year: '3', nationalId: '10000000000004', status: 'ACTIVE' },
    ];
